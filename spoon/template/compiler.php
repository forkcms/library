				...
				foreach($matches as $match)
				{
					...
					elseif($inIteration)
					{
						...
						if(
							...
							|| (is_array(' . $baseVariable . ') && isset(' . $variable . ') && empty(' . $variable . ') === false))
						{
							?>';
						$replace[] = '<?php } ?>';
						...
						$replace[] = '<?php if(
							(is_object(' . $baseVariable . ') && (!' . $objectVariable . ' || ' . $objectVariable . ' == \'\' || ' . $objectVariable . ' === false))
							|| (is_array(' . $baseVariable . ') && (!isset(' . $variable . ') || empty(' . $variable . ') === true))): ?>';
						$replace[] = '<?php endif; ?>';
					}
					else
					{
						...
						// replace with
						$replace[] = '<?php
						if(isset(' . $variable . ') && empty(' . $variable . ') === false)
						{
							?>';
						$replace[] = '<?php } ?>';

						// inverse option
						$replace[] = '<?php if(!isset(' . $variable . ') || empty(' . $variable . ') === true): ?>';
						$replace[] = '<?php endif; ?>';
					}
